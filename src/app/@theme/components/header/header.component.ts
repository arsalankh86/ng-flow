...
export class HeaderComponent implements OnInit {
  ...
  onItemSelection( title ) {
    if (title === 'Log out') {
      ...
      // this.user = Utils.decodeJwt(this.cookieService.get('user'));
      this.cookieService.delete('restaurants-'+this.user.client_id, '/');
      this.cookieService.delete('selected-restaurant-'+this.user.client_id, '/');
      this.cookieService.delete('selected-restaurant-index-'+this.user.client_id, '/');
