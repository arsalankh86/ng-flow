...
export class ApiService {
  ...
  constructor(private http: HttpClient) {
    this.apiEndPoints = {
      ...
      getPendingOrdersByRunnerId: 'order/pending/runner/:runner_id',
  ...
  getPendingOrdersByRunnerId(runner_id: number): Observable<any> {
    const url = this.apiEndPoints.getPendingOrdersByRunnerId.replace(':runner_id', runner_id);
    // console.log(url);
    return this.http
    .get<any>(url, this.getHeaders())
    .pipe(
